...
type CompetitionTypeIdRequest struct {
	Id int64 `json:"id" validate:"required|gt:0"`
}

type CompetitionTypeSportType struct {
	model.CompetitionType
	SportType model.SportType `json:"sport_type"`
}

type CompetitionTypeListRequest struct {
...
type CompetitionTypeListResponse struct {
	Total    int64                       `json:"total"`
	Page     int                         `json:"page"`
	PageSize int                         `json:"page_size"`
	List     []*CompetitionTypeSportType `json:"list"`
}

type CompetitionTypeAddRequest struct {
	SportTypeId int64  `json:"sport_type_id"`
...
type CompetitionTypeUpdateRequest struct {
	Id          int64  `json:"id" validate:"required|gt:0"`
	SportTypeId int64  `json:"sport_type_id"`
	Name        string `json:"name" validate:"string|max_len:40"`
	Icon        string `json:"icon" validate:"required|url"`
