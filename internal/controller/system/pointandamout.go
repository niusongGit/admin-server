...
type PointAndAmount struct {
}

func (c PointAndAmount) Info(ctx *gin.Context) {

	data, err := service.NewSystemService(orm.GetDBWithContext(ctx.Request.Context())).GetPointAndAmount()
...
func (c PointAndAmount) Update(ctx *gin.Context) {

	var req = schema.PointAndAmountRequest{}
	...
	err := service.NewSystemService(orm.GetDBWithContext(ctx.Request.Context())).PointAndAmountUpdate(req)
...
func NewPointAndAmount() PointAndAmount {
	return PointAndAmount{}
}
